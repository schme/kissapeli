...
LDFLAGS=
SRCF= src
SOURCES= $(SRCF)\win_kissapeli.cpp $(SRCF)\kissapeli.cpp $(SRCF)\render.cpp $(SRCF)\memorystack.cpp $(SRCF)\kms_glutils.cpp $(SRCF)\win_audio.cpp
DEFINES= -DGLEW_STATIC -DBUILD_INTERNAL -DENABLE_CONSOLE -DLOGLEVEL=1
